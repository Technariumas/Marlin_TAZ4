...
#define STRING_CONFIG_H_AUTHOR "(Technarium)" // Who made the changes.
...
#define PID_MAX 124 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#ifdef PIDTEMP
  //#define PID_DEBUG // Sends debug data to the serial port.
  //#define PID_OPENLOOP 1 // Puts PID in open loop. M104/M140 sets the output power from 0 to PID_MAX
  #define PID_FUNCTIONAL_RANGE 16 // If the temperature difference between the target temperature and the actual temperature
                                  // is more then PID_FUNCTIONAL_RANGE then the PID will be shut off and the heater will be set to min/max.
  #define PID_INTEGRAL_DRIVE_MAX 120  //limit for the integral term
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5,100.5,1600,858}  // default steps per unit for TAZ {X,Y,Z,E}
